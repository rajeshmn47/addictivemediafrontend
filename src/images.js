...
function ImageList() {
  ...
  const handleEditItem = (id) => {
    console.log(id);
    setEditItem(images.find((f) => f.userId === id));
    setEditpopupOpen(true);
  };

  const handleDelete = (id) => {
    console.log(id, "userid");
    setDeleteItem(images.find((f) => f.userId === id));
                ...
                <tr>
                  ...
                  <td>
                    <p>
                      resume{" "}
                      <a
                        href={`https://addictivebackend.herokuapp.com/${l.resume}`}
                      >
                        link
                      </a>
                    </p>
                  ...
                  <td>
                    <EditOutlineIcon
                      ...
                      onClick={() => handleEditItem(l.userId)}
                    />
                    <DeleteOutlineIcon
                      style={{
                        cursor: "pointer",
